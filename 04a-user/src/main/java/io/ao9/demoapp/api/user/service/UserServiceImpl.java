...
import io.ao9.demoapp.api.user.data.AlbumFeignClient;
import io.ao9.demoapp.api.user.data.UserEntity;
import io.ao9.demoapp.api.user.data.UserRepository;
import io.ao9.demoapp.api.user.shared.UserDto;
import io.ao9.demoapp.api.user.ui.model.AlbumResponseModel;
